    ...
    + '<div id="ace-pomo-panel">'
      ...
      + '<div class="ace-pomo-settings">'
        ...
        + '<div class="ace-pomo-settings-body" id="ace-pomo-settings-body">'
          + '<div class="ace-pomo-set-row"><label for="ace-pomo-focusmin">Focus (min)</label><input class="ace-pomo-num" id="ace-pomo-focusmin" type="number" min="1" max="99"></div>'
          + '<div class="ace-pomo-set-row"><label for="ace-pomo-shortmin">Short break (min)</label><input class="ace-pomo-num" id="ace-pomo-shortmin" type="number" min="1" max="30"></div>'
          + '<div class="ace-pomo-set-row"><label for="ace-pomo-longmin">Long break (min)</label><input class="ace-pomo-num" id="ace-pomo-longmin" type="number" min="1" max="60"></div>'
          + '<div class="ace-pomo-set-row"><label for="ace-pomo-longevery">Long break every</label><input class="ace-pomo-num" id="ace-pomo-longevery" type="number" min="2" max="10"></div>'
